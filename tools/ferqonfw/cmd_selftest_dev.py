...
cmd_selftest_dev.py
-------------------
Development-only selftest command that supports the in-process emulator.
...
def cmd_selftest_dev(args: argparse.Namespace) -> int:
    """Run self-test matrix (development: supports emulator)."""
    if args.emulator:
